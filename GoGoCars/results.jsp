        ...
        <div class="sidenav">
            ...
            <button class="filters-btn" onclick="dropDownMenu('filters')">
                ...
                <div class="dropdown-container" id="filters" style="z-index: 10; position:relative; ">
                    <button class="clear-filters"><a href="searchController.jsp?pickUp=<%=pickUp%>&dropOff=<%=dropOff%>" style="background-color: #f0f0f0; color:black; border: none;"> Clear Filters </a></button>
